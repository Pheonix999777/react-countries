...
export const Header = () => {
  const { isDarkMode, toggleTheme } = useContext(MainContext);
  return (
    <header className={isDarkMode ? sty.dark : sty.header}>
      <Container>
        <div className={sty.header__div}>
          <a
            className={isDarkMode ? sty.header__darktext : sty.header__text}
            href="#"
          >
            Where in the world?
          </a>
          ...
          <button
            className={isDarkMode ? sty.header__btndark : sty.header__btn}
            href="#"
            onClick={toggleTheme}
          >
            <svg
              className={sty.header__svg}
            ...
            >
              <path
                ...
                stroke={isDarkMode ? "#111517" : "white"}
                strokeWidth="1.25"
              />
            </svg>
